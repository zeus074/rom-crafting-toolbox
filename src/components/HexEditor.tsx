...
const HexEditor: React.FC<HexEditorProps> = ({ segment, className }) => {
  ...
  return (
    <div ref={containerRef} className={`font-mono text-sm overflow-auto max-h-[500px] p-4 bg-card rounded-md ${className}`}>
      {segment.type === 'blank' ? (
        ...
        <div className="animate-fade-in">
          <div className="sticky top-0 bg-card z-10 pb-2 border-b mb-3 flex">
